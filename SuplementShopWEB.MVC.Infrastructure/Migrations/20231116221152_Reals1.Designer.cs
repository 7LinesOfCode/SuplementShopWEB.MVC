...
namespace SuplementShopWEB.MVC.Infrastructure.Migrations
{
    ...
    [Migration("20231116221152_Reals1")]
    partial class Reals1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SuplementShopWEB.MVC.Domain.Models.Type", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SuplementShopWEB.MVC.Domain.Models.Item", b =>
                {
                    b.HasOne("SuplementShopWEB.MVC.Domain.Models.Type", "Type")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("SuplementShopWEB.MVC.Domain.Models.Order", b =>
                {
                    ...
                    b.HasOne("SuplementShopWEB.MVC.Domain.Models.Item", "Item")
                        .WithMany("Order")
